<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  ...
  <xsl:template name="user.head.content">
    ...
    <link rel="shortcut icon" href="http://staging.elasticsearch.org/content/themes/elasticsearch-org/favicon.ico" />
    <meta property="og:locale" content="en_US" />
    <meta property="og:type" content="website" />
    <meta property="og:title" content="Reference Guide | Elasticsearch" />
    <meta property="og:url" content="http://staging.elasticsearch.org/guide/" />
    <meta property="og:site_name" content="" />
    <link rel="stylesheet" id="prettify-gc-syntax-highlighter-css" href="http://staging.elasticsearch.org/content/plugins/prettify-gc-syntax-highlighter/prettify.css?ver=3.5.2" type="text/css" media="all" />
    <link rel="stylesheet" id="appStyles-css" href="http://staging.elasticsearch.org/content/themes/elasticsearch-org/css/main.css?ver=1377893249" type="text/css" media="all" />
    <script type="text/javascript" src="http://staging.elasticsearch.org/wp-includes/js/jquery/jquery.js?ver=1.8.3" />
    ...
    <header>
      <div class="container">
        <div id="header-inner">
          ...
          <h1 id="header-logo">
            <a class="faux" href="http://staging.elasticsearch.org">Elasticsearch</a>
          </h1>
    ...
    <footer>
      <div id="drawer_container" class="full_wrapper">
        <div id="drawer_inner" class="container">
          <div class="block">
            <img class="creeper" src="http://staging.elasticsearch.org/content/uploads/2013/03/training_icon.png" alt="" />
            <h3>Training</h3>
            <p>
              Want to
          ...
          <div class="block">
            <img class="creeper" src="http://staging.elasticsearch.org/content/uploads/2013/03/dev_icon.png" alt="" />
            <h3>Dev Support</h3>
            <p>
              Need help with
          ...
          <div class="block">
            ...
            <div class="block_content">
              ...
              <ul class="drawer_highlights">
                <li>
                  <div class="img">
                    <img alt="clock" src="http://staging.elasticsearch.org/content/uploads/2013/03/clock.png" />
                  </div>
                  <p>24/7 response time available always</p>
                </li>
                <li class="wide">
                  <div class="img">
                    <img alt="flag" src="http://staging.elasticsearch.org/content/uploads/2013/03/flag.png" />
                  </div>
                  <p>Support from team that built Elasticsearch</p>
                </li>
                <li>
                  <div class="img">
                    <img alt="star" src="http://staging.elasticsearch.org/content/uploads/2013/03/star.png" />
                  </div>
...
function gformInitSpinner_4(){jQuery('#gform_4').submit(function(){if(jQuery('#gform_ajax_spinner_4').length == 0){jQuery('#gform_submit_button_4, #gform_wrapper_4 .gform_previous_button, #gform_wrapper_4 .gform_next_button, #gform_wrapper_4 .gform_image_button').attr('disabled', true); jQuery('#gform_submit_button_4, #gform_wrapper_4 .gform_next_button, #gform_wrapper_4 .gform_image_button').after('<' + 'img id="gform_ajax_spinner_4"  class="gform_ajax_spinner" src="http://staging.elasticsearch.org/content/plugins/gravityforms/images/spinner.gif" alt="" />'); }} );}jQuery(document).ready(function($){gformInitSpinner_4();jQuery('#gform_ajax_frame_4').load( function(){var contents = jQuery(this).contents().find('*').html();var is_postback = contents.indexOf('GF_AJAX_POSTBACK') >= 0;if(!is_postback){return;}var form_content = jQuery(this).contents().find('#gform_wrapper_4');var is_redirect = contents.indexOf('gformRedirect(){') >= 0;jQuery('#gform_submit_button_4').removeAttr('disabled');var is_form = !(form_content.length <= 0 || is_redirect);if(is_form){jQuery('#gform_wrapper_4').html(form_content.html());jQuery(document).scrollTop(jQuery('#gform_wrapper_4').offset().top);if(window['gformInitDatepicker']) {gformInitDatepicker();}if(window['gformInitPriceFields']) {gformInitPriceFields();}var current_page = jQuery('#gform_source_page_number_4').val();gformInitSpinner_4();jQuery(document).trigger('gform_page_loaded', [4, current_page]);}else if(!is_redirect){var confirmation_content = jQuery(this).contents().find('#gforms_confirmation_message').html();if(!confirmation_content){confirmation_content = contents;}setTimeout(function(){jQuery('#gform_wrapper_4').replaceWith('<' + 'div id=\'gforms_confirmation_message\' class=\'gform_confirmation_message_4\'' + '>' + confirmation_content + '<' + '/div' + '>');jQuery(document).scrollTop(jQuery('#gforms_confirmation_message').offset().top);jQuery(document).trigger('gform_confirmation_loaded', [4]);}, 50);}else{jQuery('#gform_4').append(contents);if(window['gformRedirect']) {gformRedirect();}}jQuery(document).trigger('gform_post_render', [4, current_page]);} );} );</script><script type='text/javascript'> jQuery(document).ready(function(){jQuery(document).trigger('gform_post_render', [4, 1]) } );
    ...
    <script type="text/javascript" src="http://staging.elasticsearch.org/content/plugins/prettify-gc-syntax-highlighter/prettify.js?ver=3.5.2" />
    <script type="text/javascript" src="http://staging.elasticsearch.org/content/plugins/prettify-gc-syntax-highlighter/launch.js?ver=3.5.2" />
    <script type="text/javascript" src="http://s0.wp.com/wp-content/js/devicepx-jetpack.js?ver=201337" />
    <script type="text/javascript" src="http://staging.elasticsearch.org/content/themes/elasticsearch-org/js/main.min.js?ver=1377890109" />
    <script type="text/javascript">
      <xsl:text disable-output-escaping="yes">//&lt;![CDATA[<![CDATA[
